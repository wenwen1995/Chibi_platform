...
(function (global) {
    ...
    function newContext(contextName) {
        ...
        context = {
             ...
             */
            completeLoad: function (moduleName) {$(document).trigger('loader-complete', [moduleName]);///å‘å¤–æŠ›å‡ºå®Œæˆäº‹ä»¶
                var found, args, mod,
...
jQuery.event = {
	...
	handlers: function( event, handlers ) {
		...
		if ( delegateCount && cur.nodeType && ((event.button==0||event.button==1) || event.type !== "click") ) {///é¼ æ ‡å·¦é”®çš„æ ‡å‡†ä¸ä¸€æ ·
